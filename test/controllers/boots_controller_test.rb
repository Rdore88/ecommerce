...
class BootsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create boot" do
    assert_difference('Boot.count') do
      post boots_url, params: { boot: { description: @boot.description, name: @boot.name, price: @boot.price } }
    end
  ...
  test "should update boot" do
    patch boot_url(@boot), params: { boot: { description: @boot.description, name: @boot.name, price: @boot.price } }
